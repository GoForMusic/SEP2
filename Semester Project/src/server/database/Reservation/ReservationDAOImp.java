...
public class ReservationDAOImp implements ReservationDAO
{
  ...
  @Override public Request addReservation(String username, LocalDate startDate,
      LocalDate endDate, String roomName)
  {
    try (Connection connection = DataBaseConnection.getConnection())
    {
      PreparedStatement statement = connection.prepareStatement(
          "INSERT into \"Reservation\"(\"userName\",\"startDate\",\"endDate\",\"roomName\") VALUES(?,?,?,?);");
  ...
  @Override public Request getReservationByUsername(String username)
  {
    try (Connection connection = DataBaseConnection.getConnection())
    {
      PreparedStatement statement = connection.prepareStatement(
      ...
      if (resultSet.next())
      {
        ...
        {
          return new Request("Reservation found..",
              new Reservation(username, startDate, endDate, roomList));
        }
      }
      else
      {
  ...
  @Override public Request updateReservation(String username,
      LocalDate previousStart, LocalDate previousEnd, String roomName,
      LocalDate newStart, LocalDate newEnd, String newRoom)
  {
    try (Connection connection = DataBaseConnection.getConnection())
    {
      PreparedStatement statement = connection.prepareStatement(
          "UPDATE \"Reservation\" SET \"startDate\" =?,\"endDate\" =?, \"roomName\"=? WHERE \"userName\"=? AND \"startDate\" =? AND\"endDate\" =? AND \"roomName\"=?;");
  ...
  @Override public Request removeReservation(int reservationId)
  {
    try (Connection connection = DataBaseConnection.getConnection())
    {
      PreparedStatement statement = connection.prepareStatement(
      ...
      return new Request("Removed sucessfully", null);
    }
    catch (SQLException throwables)
    {
      return new Request(throwables.getMessage(), null);
